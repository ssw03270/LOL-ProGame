...
class VideoClass:
    ...
    def get_video_info(self, raw_video):
        video_list = []
        check_no_game = ["All", "Match", "Opening", "Draw", "interview"]
        for video in raw_video:
            ...
            video_info = {"original_title": video_original_title, "title": video_title,
                          "additional_info": video_additional, "link": video_link, "img": video_img,
                          "teams": video_teams, "world": video_world}
    ...
    def get_world_video(self, original_title):
        world_list = ["LCK", "LCS", "LEC", "LPL", "MSI"]
        world_in_video = ""
